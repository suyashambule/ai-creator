const Template = [
    ...
    },
    {
        ...
        icon:'https://cdn-icons-png.flaticon.com/128/8061/8061315.png',
        category: 'programming',
       
        slug: 'programming-code-writer',
        aiPrompt: 'Write programming code based on language and goal that user provided and make sure to provide step by step explanation and give me output in rich text editor format',
        form: [
            {
                label: 'Enter programming langauge name',
                field: 'input',
                name: 'language',
                required:true
            },
            {
                label:'Enter the app goal / purpose',
                field:'textarea',
                name:'goal',
                required:true
            }
